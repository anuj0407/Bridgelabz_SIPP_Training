...
class Bikes extends Vehicless {
 public Bikes(String vehicleNumber, double rentalRate, String insurancePolicyNumber) {
...
public class VehicleRentalSystem {
 public static void main(String[] args) {
     ...
     Vehicless bike1 = new Bikes("5678", 500.0, "BIKE456");
